...
struct outRecieved : public cadmium::out_port<string>{};
...
int main(int argc, char *argv[])
{
	...
	string myLoadInFile = INPUT_DIR + "DestinationTest_Load.txt";
    ...
    dynamic::modeling::Ports oports_TOP = {typeid(outRecieved)};
    dynamic::modeling::Models submodels_TOP = {input_reader_getload,myDestination};
    dynamic::modeling::EICs eics_TOP = {};
    dynamic::modeling::EOCs eocs_TOP = {
        dynamic::translate::make_EOC<Destination_defs::outRecieved,outRecieved>("myDestination"),
    };

    dynamic::modeling::ICs ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<oACLoad>::out,Destination_defs::inLoad>("input_reader_getload","myDestination")
    };
    ...
    /*************** Loggers *******************/
    static ofstream out_messages(LOG_DIR+"Destination_Test_output_messages.txt");
    ...
    static ofstream out_state(LOG_DIR+"Destination_Test_output_state.txt");
